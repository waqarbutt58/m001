...
device = "cuda"  # or "cpu"
model_path = "weights/dpt_swin2_large_384.pt"  # Adjust the path to your weights file
model_type = "dpt_swin2_large_384"  # Ensure this matches the weights
# Load the model
...
torch.save(model.state_dict(), "pothole_midas_model_swine2.pth")
